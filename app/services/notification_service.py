...
class NotificationService:
    ...
    async def notify_new_lead(self, lead_data: dict):
        ...
        logger.info("--- notify_new_lead started ---")
        ...
        whatsapp_msg = f"New lead: {lead_data.get('name', 'N/A')} from {lead_data.get('source', 'N/A')} - Intent: {lead_data.get('intent', 'N/A')}"
    ...
    async def notify_hot_lead(self, lead_data: dict):


        """Send urgent notification for hot lead"""


        logger.info("--- notify_hot_lead started ---")
        ...
        whatsapp_msg = f"🚨 HOT LEAD ALERT! 🚨 {lead_data.get('name', 'N/A')} from {lead_data.get('source', 'N/A')} - Ready to buy!"
